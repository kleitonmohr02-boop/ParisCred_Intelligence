...
# SEED AUTOMATICO EM PRODUCAO
def rodar_seed_se_necessario():
    """Roda o seed automaticamente em produção se não houver clientes"""
...
# Rodar seed ao importar o app
rodar_seed_se_necessario()
